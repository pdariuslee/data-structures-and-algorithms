...
const firstLetters = (arr) => {
  ...
  let ans2 = arr.map(str => {

    let arrOfFirstLtr = str.charAt(0);

    return arrOfFirstLtr;
...
const standardizePhoneNumbers = (arr) => {
  ...
  let ans4 = arr.map(el => {
    ...
    let alterNum = el.substring(1,4);
    let alterNum2 = el.substring(6,9);
    let alterNum3 = el.substring(10,14);
    return (alterNum + alterNum2 + alterNum3);
  });
